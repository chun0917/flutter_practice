...
import 'package:flutter_application_1229/aqi_servicedetail.dart';
import 'package:flutter_application_1229/aqi_detail.dart';
void main() {
...
class _AQIListState extends State<AQIList> {
  Future<List<Stations>>? futureStationList;
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FutureBuilder<List<Stations>>(
